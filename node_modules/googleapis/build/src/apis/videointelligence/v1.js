...
(function (videointelligence_v1) {
    ...
    class Resource$Projects$Locations$Corpora {
        constructor(context) {
            this.context = context;
            this.operations = new Resource$Projects$Locations$Corpora$Operations(this.context);
        }
    }
    videointelligence_v1.Resource$Projects$Locations$Corpora = Resource$Projects$Locations$Corpora;
    class Resource$Projects$Locations$Corpora$Operations {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
    ...
    videointelligence_v1.Resource$Projects$Locations$Corpora$Operations = Resource$Projects$Locations$Corpora$Operations;
    class Resource$Projects$Locations$Corpura {
        constructor(context) {
            this.context = context;
            this.operations = new Resource$Projects$Locations$Corpura$Operations(this.context);
        }
    }
    videointelligence_v1.Resource$Projects$Locations$Corpura = Resource$Projects$Locations$Corpura;
    class Resource$Projects$Locations$Corpura$Operations {
        constructor(context) {
            this.context = context;
        }
        get(paramsOrCallback, optionsOrCallback, callback) {
    ...
    videointelligence_v1.Resource$Projects$Locations$Corpura$Operations = Resource$Projects$Locations$Corpura$Operations;
