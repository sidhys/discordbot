...
export declare namespace videointelligence_v1 {
    ...
    export class Resource$Projects$Locations$Corpora$Operations {
         ...
         * @return {object} Request object
         */
        get(params: Params$Resource$Projects$Locations$Corpora$Operations$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Corpora$Operations$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunning_Operation>;
        get(params: Params$Resource$Projects$Locations$Corpora$Operations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Corpora$Operations$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunning_Operation>, callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
        get(params: Params$Resource$Projects$Locations$Corpora$Operations$Get, callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
        get(callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
    }
    export interface Params$Resource$Projects$Locations$Corpora$Operations$Get extends StandardParameters {
        /**
         * The name of the operation resource.
         */
        name?: string;
    ...
    export class Resource$Projects$Locations$Corpura$Operations {
         ...
         * @return {object} Request object
         */
        get(params: Params$Resource$Projects$Locations$Corpura$Operations$Get, options: StreamMethodOptions): GaxiosPromise<Readable>;
        get(params?: Params$Resource$Projects$Locations$Corpura$Operations$Get, options?: MethodOptions): GaxiosPromise<Schema$GoogleLongrunning_Operation>;
        get(params: Params$Resource$Projects$Locations$Corpura$Operations$Get, options: StreamMethodOptions | BodyResponseCallback<Readable>, callback: BodyResponseCallback<Readable>): void;
        get(params: Params$Resource$Projects$Locations$Corpura$Operations$Get, options: MethodOptions | BodyResponseCallback<Schema$GoogleLongrunning_Operation>, callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
        get(params: Params$Resource$Projects$Locations$Corpura$Operations$Get, callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
        get(callback: BodyResponseCallback<Schema$GoogleLongrunning_Operation>): void;
    }
    export interface Params$Resource$Projects$Locations$Corpura$Operations$Get extends StandardParameters {
        /**
         * The name of the operation resource.
         */
        name?: string;
